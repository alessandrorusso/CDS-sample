...
@RestController
@RequestMapping("/api/local-app-kafka")
public class LocalAppKafkaResource {
    private final Logger log = LoggerFactory.getLogger(LocalAppKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public LocalAppKafkaResource(KafkaProperties kafkaProperties) {
